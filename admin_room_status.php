...
<body>
	...
	<div style="margin-left:25%;padding:1px 16px;height:1000px;">
		...
		<table class="basic_box">
			<tr>
				<td colspan="6">
					<p style="font-size: 28px; text-align: center; text-decoration: underline;"><b>Admin Room Status</b></p>
				</td>
			<tr>
				<th>Booking ID</th>
				<th>Name</th>
		...
		<table class="basic_box">
			<tr>
				...
				<td colspan="3">Enter Room number to give:</td>
				<td colspan="2">
					<form action="confirm_room.php" method="post">
			...
			<tr>
				...
				<td style="text-align: center;"><button type="submit">Confirm</button>
					<button type="submit" formaction="cancel_room.php">Cancel Booking</button>
				</td>
			</tr>
		</table>
	</div>
