	...
	<div style="margin-left:25%;padding:1px 16px;height:1000px;">
		...
		<div class="basic_box">
			<table border="1">
				<tr>
					<td colspan="6">
						<p style="font-size: 28px; text-align: center; text-decoration: underline;"><b>Payment</b></p>
					</td>
				<tr>
					<th>Booking ID</th>
					<th>Name</th>
			...
			<table>
				<tr>
					<td colspan="1">Enter Token number:</td>
					<td colspan="2">
						<form action="token.php" method="post">
							<input type="number" name="token_no">
					</td>
			...
			<table>
				<tr>
					...
					<td style="color: #094198;"><b>Register for Frequent user</b></td>
				</tr>
				<tr>
					<td></td>
				</tr>
				...
				<tr>
					...
					<td><button type="button"><a style="text-decoration: none;  font-size: 25px;" href="freqsignup.php">Register</a></button></td>
				</tr>
			</table>
