...
<head>
	<title>Frequent user Sign Up</title>
</head>
<style>
	div {
		width: 40%;
...
<body>
	...
	<div style="background-color: #f2f2f2;">
		<form action="freqsignedup.php" method="post">
			<table>
				<tr>
					<td colspan="2">
						<p style="font-size: 35px; font-family: 'Times New Roman', serif; color: #009999;"><b>Frequent user SignUp</b></p>
					</td>
				</tr>
				<tr>
